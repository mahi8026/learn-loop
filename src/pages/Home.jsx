        ...
        <section className="mb-20">
          ...
          {loading ? (
            <p className="text-center text-indigo-500 dark:text-indigo-300">
              <span className="animate-pulse">Loading featured courses...</span> 
            </p>
          ) : error ? (
            ...
            {[
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 text-base">
                    {index === 0 && "Learn by doing with hands-on labs and direct access to expert mentors."}
                    {index === 1 && "Study at your own pace, anytime, anywhere, fitting learning around your life."}
                    {index === 2 && "Gain skills directly applicable to the current job market and industry needs."}
                </p>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            {instructorData.map((instructor, index) => (
              <motion.div
                key={index}
                variants={itemVariants}
                className="p-6 flex items-center space-x-4 rounded-xl shadow-xl transition-colors duration-300 
